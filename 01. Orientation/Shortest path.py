...
def test_make_decision():
    ...
    # TEST 1, should return "L" since left path has 
    # length 5 which is < right path with length 8
    length_1 = 2
    length_2 = 3
    length_3 = 4
    length_4 = 4
    ...
    # TEST 2, should return "R" since left path still 
    # has length 5 but right is only 3.
    length_3 = 1
    length_4 = 2
